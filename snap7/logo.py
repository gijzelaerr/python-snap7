...
class Logo(object):
    """
    A snap7 Siemens Logo client: There are two main comfort functions
    available :func:`Logo.read` and :func:`Logo.write`.
    ...
    * VW12 for a word (used for analog values)
    ...
    def connect(self, ip_address, tsap_snap7, tsap_logo, tcpport=102):
        """
        Connect to a Siemens LOGO server. Howto setup Logo communication
         configuration see: http://snap7.sourceforge.net/logo.html
