"""
Snap7 server using ctypes to interface with the native Snap7 C library.
"""
...
from snap7.type import SrvEvent, Parameter, cpu_statuses, server_statuses, SrvArea, longword, WordLen, S7Object, CDataArrayType

logger = logging.getLogger(__name__)

# Import Server after other imports to avoid circular dependency
from snap7.server import Server  # noqa: E402


class ClibServer(Server):
    """
    A snap7 server using ctypes to interface with the native Snap7 C library.
